    ...
    return (
        <div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
                ...
                <textarea
                    className="w-full px-3 py-8 border border-gray-400 rounded-md resize-none h-80 text-sm placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:shadow-lg focus:shadow-blue-200 dark:bg-gray-200 dark:focus:shadow-none transition duration-200"
                ...
                <div className="relative w-full">
                    ...
                    <textarea
                        className="w-full px-3 py-8 border border-gray-400 rounded-md resize-none h-80 bg-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 focus:shadow-lg focus:shadow-indigo-100 dark:bg-gray-300 dark:text-gray-700 dark:focus:shadow-none transition duration-200"
                        value={output}
                        readOnly
                    />
            ...
            <p className="text-center text-gray-500 mt-6 dark:text-gray-200">
