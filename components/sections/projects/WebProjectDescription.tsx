...
export const WebProjectDescription = () => {
  ...
  return (
    <article className={`rounded-xl border border-slate-200 card-shadow bg-white ${styles['card-effect']}`}>
      ...
      <div className="py-8 px-8">
        ...
        <p className='font-light text-sm mt-1 text-center leading-relaxed'>Desarrollé un eCommerce multivendedor en WordPress, integrando CSS y Bootstrap para un diseño responsivo y fácil gestión por parte de cada tienda.</p>
        <div>
