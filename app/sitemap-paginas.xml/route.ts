...
const PAGES = [
  ...
  { loc: `${BASE}/herramientas/convertidor-de-imagenes`,                  lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.6' },
  { loc: `${BASE}/herramientas/comprimir-imagenes-gratis`,                lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.6' },
  { loc: `${BASE}/herramientas/minuscula-a-mayuscula`,                    lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.6' },
