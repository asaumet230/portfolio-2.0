    ...
    <header className="pt-6">
      <div className="container grid grid-cols-2 max-[920px]:flex flex-col-reverse">
        ...
        <div className="flex flex-col justify-center text-left p-3 max-[920px]:text-center">
          ...
          <p className="text-lg mb-8 pr-8 max-[920px]:pr-0">Explora el arte de la tecnología a través de mi portafolio, donde mis <strong>4 años</strong> de experiencia en <strong>desarrollo web </strong> y <strong>desarrollo de apps móviles</strong> se traducen en soluciones creativas y robustas para cada desafío digital.</p>
